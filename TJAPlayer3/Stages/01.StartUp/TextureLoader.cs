...
namespace TJAPlayer3
{
    class TextureLoader
    {
        ...
        public void LoadTexture()
        {
            ...
            for (int i = 0; i < Crown_t.Length; i++)
            {
                Crown_t[i] = TxC(@"Crown" + i.ToString() + ".png");
            }
            #endregion
            #region 1_タイトル画面
            Title_Background = TxC(TITLE + @"Background.png");
            Title_PRESS = TxC(TITLE + @"PRESS.png");
            Title_pass_0 = TxC(TITLE + @"pass_0.png");
            Title_pass_1 = TxC(TITLE + @"pass_1.png");
            Title_pass_2 = TxC(TITLE + @"pass_2.png");
            Title_yes = TxC(TITLE + @"pass_yes.png");
            Title_no = TxC(TITLE + @"pass_no.png");
            Title_base = TxC(TITLE + @"base.png");
            Title_don = TxC(TITLE + @"don.png");
            Title_ka = TxC(TITLE + @"ka.png");
            ...
            SongSelect_Frame_Score_4 = TxC(SONGSELECT + @"Frame_Score_4.png");
            SongSelect_Frame_Score_5 = TxC(SONGSELECT + @"Frame_Score_5.png");
            ...
            SongSelect_Skip = TxC(SONGSELECT + @"スキップ.png");
            for (int i = 0; i < SongSelect_Bar_Genre.Length; i++)
            {
                SongSelect_Bar_Genre[i] = TxC(SONGSELECT + @"Bar_Genre_" + i.ToString() + ".png");
            }
            for (int i = 0; i < Bar_Center.Length; i++)
            {
                Bar_Center[i] = TxC(SONGSELECT + @"Bar_Center_" + i.ToString() + ".png");
            }
            for (int i = 0; i < SongSelect_Bar_Genre2.Length; i++)
            {
                SongSelect_Bar_Genre2[i] = TxC(SONGSELECT + @"Bar_Genre_" + i.ToString() + "_2.png");
            }
            ...
            {
                Don[i] = TxC(SONGSELECT + @"Don\" + i.ToString() + ".png");
            }
            ...
            Result_paneru = TxC(RESULT + @"パネル.png");
        ...
        public void DisposeTexture()
        {
            ...
            for (int i = 0; i < Crown_t?.Length; i++)
            {
                TJAPlayer3.tテクスチャの解放(ref Crown_t[i]);
            }
            for (int i = 0; i < 2; i++)
            {
            ...
            #region 1_タイトル画面
            TJAPlayer3.tテクスチャの解放(ref Title_Background);
            TJAPlayer3.tテクスチャの解放(ref Title_PRESS);
            TJAPlayer3.tテクスチャの解放(ref Title_pass_0);
            TJAPlayer3.tテクスチャの解放(ref Title_pass_1);
            TJAPlayer3.tテクスチャの解放(ref Title_pass_2);
            TJAPlayer3.tテクスチャの解放(ref Title_yes);
            TJAPlayer3.tテクスチャの解放(ref Title_no);
            TJAPlayer3.tテクスチャの解放(ref Title_don);
            TJAPlayer3.tテクスチャの解放(ref Title_ka);
            TJAPlayer3.tテクスチャの解放(ref Title_don);
            TJAPlayer3.tテクスチャの解放(ref Title_Menu);
            #endregion
            ...
            TJAPlayer3.tテクスチャの解放(ref SongSelect_Frame_Score_4);
            TJAPlayer3.tテクスチャの解放(ref SongSelect_Frame_Score_5);
            ...
            TJAPlayer3.tテクスチャの解放(ref SongSelect_Skip);
            for (int i = 0; i < SongSelect_Bar_Genre.Length; i++)
            {
            ...
            for (int i = 0; i < Bar_Center.Length; i++)
            {
                TJAPlayer3.tテクスチャの解放(ref Bar_Center[i]);
            }
            for (int i = 0; i < SongSelect_Bar_Genre2.Length; i++)
            {
                TJAPlayer3.tテクスチャの解放(ref SongSelect_Bar_Genre2[i]);
            }
            for (int i = 0; i < (int)Difficulty.Total; i++)
            {
            ...
            for (int i = 0; i < Don.Length; i++)
            {
                TJAPlayer3.tテクスチャの解放(ref Don[i]);
            }
            ...
            TJAPlayer3.tテクスチャの解放(ref Result_paneru);
            #endregion
        ...
        public CTexture SongSelect_Background,
            ...
            SongSelect_Frame_Score_4,
            SongSelect_Frame_Score_5,
        ...
        public CTexture[] SongSelect_GenreBack = new CTexture[9],
            ...
            SongSelect_Bar_Genre2 = new CTexture[12],
            Bar_Center = new CTexture[11],
            SongSelect_NamePlate = new CTexture[1];
        public CTexture[] Don = new CTexture[61];
